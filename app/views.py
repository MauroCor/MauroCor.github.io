...
from app.serializers import FixedCostSerializer
...
class FixedCostListView(APIView):
    ...
    def put(self, request):
        ...
        existing_record = FixedCost.objects.filter(
            ...
            date_to=new_data['date_to']
        ).first()

        # Si encontramos un registro con los mismos name, date_from, y date_to, actualizar ese registro
        if existing_record:
